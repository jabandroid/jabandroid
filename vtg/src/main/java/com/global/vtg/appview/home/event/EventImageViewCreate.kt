...
class EventImageViewCreate(context: Context?, name: Bitmap?, url: String?, count:Int, isnew :Boolean, completedTripDetailActivity: CreateEventReviewFragment, v: LinearLayout) : RelativeLayout(context) {
      ...
      val view=  View.inflate(context, R.layout.include_image, this)
       ...
       // listOfImages.add(obj.attributes.signed_url)
        ...
        ic_delete.setOnClickListener {
            completedTripDetailActivity.onDeleteClick(it.tag as Int,v)
