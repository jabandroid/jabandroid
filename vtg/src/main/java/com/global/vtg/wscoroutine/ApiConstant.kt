...
object ApiConstant {
    ...
    const val TIME_OUT_CONNECTION_STATUS_1 = "510"
    ...
    const val HEADER_USERNAME: String = "username"
    const val HEADER_PASSWORD: String = "password"
    const val HEADER_ROLE: String = "role"
