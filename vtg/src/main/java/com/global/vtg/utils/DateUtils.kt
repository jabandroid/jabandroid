...
object DateUtils {
    ...
    var simpleDateTimeFormatter = SimpleDateFormat(
        "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'",
        Locale.getDefault()
    ) //2016-05-03T09:45:15.724Z
    var twentyFourHrFormat: DateFormat =
        SimpleDateFormat("HH:mm", Locale.getDefault()) //HH for hour of the day (0 - 23)
    ...
    fun convertDateTimeZone(
        timeZone: String,
        dateTime: String,
        formatter: String,
        strOutPuttformatter: String
    ): String {
        //        String s = "2011-01-01 12:00:00";
    ...
    fun convertTimeZondeDefaultTo24Hrs(
        timeZone: String, dateTime: String,
        dateFormat: SimpleDateFormat, dateParse: SimpleDateFormat
    ): String {
        //        String s = "2011-01-01 12:00:00";
