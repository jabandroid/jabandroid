package com.global.vtg.base.fragment
...
internal fun AppActivity.notifyFragment(isAnimation: Boolean = true) {
    if (stack.size > 1) {
...
fun <T> AppActivity.replaceAllFragment(fragmentEnum: AppFragmentState, keys: T? = null, isAnimation: Boolean = true) {
    ft = supportFragmentManager.beginTransaction()
...
fun <T> AppActivity.addFragmentInStack(fragmentEnum: AppFragmentState, keys: T? = null, isAnimation: Boolean = true) {
    ft = supportFragmentManager.beginTransaction()
    if (isAnimation) {
        ft?.setCustomAnimations(
                R.anim.enter_from_right,
...
fun AppActivity.popFragment(isAnimation: Boolean = true) {
    ft = supportFragmentManager.beginTransaction()
...
fun <T> AppActivity.moveFragmentToTop(appFragmentState: AppFragmentState, `object`: T? = null, isAnimation: Boolean = true) {
    ft = supportFragmentManager.beginTransaction()
    if (isAnimation) {
        ft!!.setCustomAnimations(
                R.anim.enter_from_right,
...
fun <T> AppActivity.addFragment(fragmentEnum: AppFragmentState, keys: Bundle? = null, isAnimation: Boolean = true, popFragment: Fragment?) {
...
fun <T> AppActivity.addFragmentAlwaysNew(fragmentEnum: AppFragmentState, keys: Bundle? = null, isAnimation: Boolean = true) {
    KeyboardUtils.hideKeyboard(getAppActivity())
//    if (ConnectivityUtils.isNetworkAvailable(getAppActivity())) {
