...
fun <T> AppFragment.addFragment(fragmentEnum: AppFragmentState, keys: Bundle? = null, isAnimation: Boolean = false, popFragment: Fragment ?= null) {
    getAppActivity().addFragment<Any>(fragmentEnum, keys, isAnimation, popFragment)
}
